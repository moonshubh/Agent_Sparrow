...
import { type DetailedSystemMetadata, healthStatusClasses } from '@/lib/log-analysis-utils'

interface EnhancedSystemOverviewCardProps {
...
export function EnhancedSystemOverviewCard({ metadata, className }: EnhancedSystemOverviewCardProps) {
  ...
  const detailedMetrics: MetricItem[] = [
    {
      label: 'Memory Usage',
      value: formatMemory(metadata.memory_usage_mb),
      icon: Cpu,
      variant: 'performance'
    },
    {
      label: 'Startup Time',
      value: formatDuration(metadata.startup_time_ms),
      icon: Clock,
      variant: 'performance'
    },
    {
    ...
    {
      label: 'Architecture',
      value: metadata.system_architecture ?? 'Unknown',
      icon: HardDrive
    },
    {
      label: 'Log Entries',
