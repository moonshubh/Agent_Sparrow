/**
 * Example Components using Modular Stores
 * 
 * These components demonstrate best practices for using the new modular
 * store architecture without any legacy dependencies.
 */
