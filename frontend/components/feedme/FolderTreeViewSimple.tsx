...
import { ChevronRight, ChevronDown, MoreHorizontal, Plus, MessageCircle } from 'lucide-react'
      ...
      <ScrollArea className="flex-1">
        <div className="p-2 space-y-1">
          ...
          >
            ...
            <FolderIcon size={16} isOpen={true} color="#0095ff" alt="All conversations" />
          ...
          >
            <div className="h-4 w-4" /> {/* Spacer for alignment */}
            <FolderIcon size={16} isOpen={false} color="#95a5a6" alt="Unassigned conversations" />
            <span className="flex-1 text-sm">Unassigned</span>
          </div>
          
          {folderList.length === 0 ? (
            <div className="text-center text-muted-foreground p-4">
              <FolderIcon size={32} isOpen={false} color="#95a5a6" alt="No folders" className="mx-auto mb-2 opacity-50" />
