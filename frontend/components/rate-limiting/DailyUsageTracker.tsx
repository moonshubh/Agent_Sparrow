    ...
    <>
      ...
      {showWarning && (
        <Alert className="fixed bottom-4 right-4 w-96 z-50 border-yellow-500/50 bg-yellow-500/10">
          ...
          <AlertDescription>
            <strong>High usage alert!</strong> You've used over 90% of your daily quota for {primaryModel === 'flash' ? 'Gemini 2.5 Flash' : 'Gemini 2.5 Pro'}. Consider switching models or waiting for the daily reset at midnight PT.
          </AlertDescription>
        </Alert>
      )}
    </>
