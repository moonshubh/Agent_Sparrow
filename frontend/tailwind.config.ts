...
const config: Config = {
  ...
  theme: {
	extend: {
		...
		// Typography scale
		fontSize: {
			'academia-xs': ['var(--text-xs, 0.8125rem)', { lineHeight: 'var(--leading-normal)' }],
			'academia-sm': ['var(--text-sm, 0.9375rem)', { lineHeight: 'var(--leading-normal)' }],
			'academia-base': ['var(--text-base, 1.0625rem)', { lineHeight: 'var(--leading-normal)' }],
			'academia-lg': ['var(--text-lg, 1.1875rem)', { lineHeight: 'var(--leading-snug)' }],
			'academia-xl': ['var(--text-xl, 1.375rem)', { lineHeight: 'var(--leading-tight)' }],
			'academia-2xl': ['var(--text-2xl, 1.625rem)', { lineHeight: 'var(--leading-tight)' }],
		},
		// Warm shadows
		boxShadow: {
