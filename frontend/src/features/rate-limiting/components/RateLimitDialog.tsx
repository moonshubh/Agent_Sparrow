...
import { formatTimeRemaining, getTimeToReset } from '@/services/api/endpoints/rateLimitApi';
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription id="rate-limit-dialog-description">
            You have reached the rate limit for Gemini {modelName} model
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="text-sm text-gray-600 space-y-1">
            <p>
              <strong>What happened?</strong> You have reached the {blockedBy.toUpperCase()} limit for 
              the Gemini {modelName} model. This helps keep the service free by staying within 
              the Google free tier limits.
            </p>
            <p>
              <strong>What is next?</strong> You can wait for the limit to reset or try using a 
          ...
          {metadata.safety_margin > 0 && (
            <div className="text-xs text-gray-500 p-2 bg-yellow-50 rounded border-l-2 border-yellow-200">
              ...
              below the actual Google limits to prevent any overage charges.
            </div>
          )}
