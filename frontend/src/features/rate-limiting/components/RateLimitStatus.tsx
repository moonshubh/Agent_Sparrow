...
import { rateLimitApi, type RateLimitStatus as RateLimitStatusType, getUtilizationLevel, formatTimeRemaining, getTimeToReset } from '@/services/api/endpoints/rateLimitApi';
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <div className="text-xs">
                    <div className="font-semibold">Rate per day: {flash_stats.rpd_used}/{flash_stats.rpd_limit}</div>
                    <div>Rate per minute: {flash_stats.rpm_used}/{flash_stats.rpm_limit}</div>
                    <div>Daily resets in: {formatTimeRemaining(getTimeToReset(flash_stats.reset_time_rpd))}</div>
                    <div>Minute resets in: {formatTimeRemaining(getTimeToReset(flash_stats.reset_time_rpm))}</div>
                  </div>
                </TooltipContent>
              </Tooltip>
            </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <div className="text-xs">
                    <div className="font-semibold">Rate per day: {pro_stats.rpd_used}/{pro_stats.rpd_limit}</div>
                    <div>Rate per minute: {pro_stats.rpm_used}/{pro_stats.rpm_limit}</div>
                    <div>Daily resets in: {formatTimeRemaining(getTimeToReset(pro_stats.reset_time_rpd))}</div>
                    <div>Minute resets in: {formatTimeRemaining(getTimeToReset(pro_stats.reset_time_rpm))}</div>
                  </div>
                </TooltipContent>
              </Tooltip>
            </div>
