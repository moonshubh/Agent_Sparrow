...
export const apiKeyService = {
  ...
  async createOrUpdateAPIKey(
    ...
    try {
      return await apiClient.post<APIKeyCreateResponse>(
        "/api/v1/api-keys/",
        request,
      );
    } catch (error) {
  ...
  async updateAPIKey(
    ...
    try {
      return await apiClient.put<APIKeyUpdateResponse>(
        `/api/v1/api-keys/${apiKeyType}`,
        request,
      );
    } catch (error) {
      throw createAPIError(error);
  ...
  async deleteAPIKey(apiKeyType: APIKeyType): Promise<APIKeyDeleteResponse> {
    try {
      return await apiClient.delete<APIKeyDeleteResponse>(
        `/api/v1/api-keys/${apiKeyType}`,
      );
    } catch (error) {
      throw createAPIError(error);
  ...
  async validateAPIKey(
    ...
    try {
      return await apiClient.post<APIKeyValidateResponse>(
