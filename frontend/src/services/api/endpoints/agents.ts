...
export const agentsAPI = {
  async list(): Promise<AgentMeta[]> {
    try {
      ...
      return [
        { id: 'primary', destination: 'primary_agent', name: 'Primary Support', description: 'General queries & KB' },
        { id: 'log_analysis', destination: 'log_analyst', name: 'Log Analysis', description: 'Logs, errors, performance' },
        { id: 'research', destination: 'researcher', name: 'Research', description: 'Web research & sources' },
      ]
    }
  },
