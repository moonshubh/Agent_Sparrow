...
// Timing configuration for various subsystems
...
// Higher-level feature toggles used in UI components
...
>(category: C, key: K): ConfigCategories[C][K] {
