...
import type { DataUIPart, UITools } from 'ai'
...
export type AgentType = 'primary' | 'log_analysis' | 'research' | 'router'

export type InteractiveAgent = Exclude<AgentType, 'router'>

export type ChatDataTypes = Record<string, unknown>

export type ChatDataPart =
  | DataUIPart<ChatDataTypes>
  | {
      type: string
      data?: unknown
      transient?: boolean
...
export interface ChatMessageMetadata {
  ...
  thinking_trace?: {
    thinking_steps?: Array<Record<string, unknown>>
  }
  logMetadata?: Record<string, unknown>
  errorSnippets?: Array<Record<string, unknown> | string>
  rootCause?: unknown
...
export type ChatUIMessage = UIMessage<ChatMessageMetadata, ChatDataTypes, UITools> & {
  agentType?: AgentType
}

/**
 * Represents a chat message in the conversation payloads
 */
 ...
 * Agent type keys
 */
export type LegacyAgentType = keyof AgentSessionLimits;
