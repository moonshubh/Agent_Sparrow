...
export function LampContainer({
  ...
  return (
    <div className={cn("relative w-full", justifyClass, className)}>
        ...
        >
          ...
          <div
            ...
            style={{
              top: "2px",
              background:
                "linear-gradient(180deg, rgba(255,255,255,0.7) 0%, rgba(255,252,240,0.5) 20%, rgba(253,245,200,0.3) 50%, rgba(253,235,160,0.15) 80%, transparent 100%)",
              filter: "blur(8px)",
              maskImage:
          ...
          <div
            ...
            style={{
              top: "8px",
              background:
                "linear-gradient(180deg, rgba(255,252,235,0.55) 0%, rgba(253,240,180,0.35) 25%, rgba(253,225,140,0.2) 50%, rgba(253,212,112,0.08) 75%, transparent 100%)",
              filter: "blur(30px)",
          ...
          <div
            ...
            style={{
              ...
              left: "calc(50% - 220px)",
              background:
                "linear-gradient(160deg, rgba(253,240,180,0.4) 0%, rgba(253,225,140,0.2) 30%, rgba(253,212,112,0.08) 60%, transparent 100%)",
              filter: "blur(35px)",
          ...
          <div
            ...
            style={{
              ...
              right: "calc(50% - 220px)",
              background:
                "linear-gradient(200deg, rgba(253,240,180,0.4) 0%, rgba(253,225,140,0.2) 30%, rgba(253,212,112,0.08) 60%, transparent 100%)",
              filter: "blur(35px)",
          ...
          <div
            ...
            style={{
              top: "50px",
              background:
                "radial-gradient(ellipse 100% 80% at 50% 0%, rgba(253,225,140,0.3) 0%, rgba(253,212,112,0.12) 40%, rgba(250,204,21,0.05) 70%, transparent 90%)",
              filter: "blur(50px)",
            }}
          />
          ...
          <div
            ...
            style={{
              ...
              left: "calc(50% - 280px)",
              background:
                "radial-gradient(ellipse 70% 80% at 80% 0%, rgba(253,220,130,0.25) 0%, rgba(250,204,21,0.08) 50%, transparent 85%)",
              filter: "blur(45px)",
            }}
          />
          ...
          <div
            ...
            style={{
              ...
              right: "calc(50% - 280px)",
              background:
                "radial-gradient(ellipse 70% 80% at 20% 0%, rgba(253,220,130,0.25) 0%, rgba(250,204,21,0.08) 50%, transparent 85%)",
              filter: "blur(45px)",
            }}
          />
          ...
          <div
            ...
            style={{
              top: "100px",
              background:
                "radial-gradient(ellipse 100% 60% at 50% 0%, rgba(253,212,112,0.18) 0%, rgba(250,204,21,0.06) 50%, transparent 80%)",
              filter: "blur(60px)",
            }}
          />
          ...
          <div
            ...
            style={{
              ...
              left: "calc(50% - 320px)",
              background:
                "linear-gradient(150deg, rgba(253,215,120,0.15) 0%, rgba(250,204,21,0.05) 50%, transparent 100%)",
              filter: "blur(40px)",
            }}
          />
          ...
          <div
            ...
            style={{
              ...
              right: "calc(50% - 320px)",
              background:
                "linear-gradient(210deg, rgba(253,215,120,0.15) 0%, rgba(250,204,21,0.05) 50%, transparent 100%)",
              filter: "blur(40px)",
            }}
          />
          ...
          <div
            ...
            style={{
              top: "280px",
              background:
                "radial-gradient(ellipse 100% 50% at 50% 0%, rgba(253,230,160,0.15) 0%, rgba(250,210,100,0.05) 60%, transparent 90%)",
              filter: "blur(40px)",
            }}
          />
        </motion.div>
      ...
      <div
        className={cn(
          "relative z-10 flex h-full w-full flex-col px-6 pt-8 text-center",
