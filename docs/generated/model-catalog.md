...
|------------|----------|----------|------|----------------|-----|-----|
| coordinators.google | `gemini-3-flash-preview` | `google` | 1.0 | 1048576 | 1000 | 10000 |
| coordinators.google_with_subagents | `gemini-3-flash-preview` | `google` | 1.0 | 1048576 | 1000 | 10000 |
| coordinators.minimax | `minimax/MiniMax-M2.1` | `openrouter` | 1.0 | 204800 | 100 | 5000 |
| coordinators.minimax_with_subagents | `minimax/MiniMax-M2.1` | `openrouter` | 1.0 | 204800 | 80 | 4000 |
...
| internal.minimax_tools | `minimax/MiniMax-M2.1` | `openrouter` | 1.0 | 204800 | 120 | 5000 |
| internal.summarizer | `gemini-2.5-flash-preview-09-2025` | `google` | 0.2 | 1048576 | 1000 | 10000 |
| subagents._default | `minimax/MiniMax-M2.1` | `openrouter` | 1.0 | 204800 | 60 | 1000 |
| zendesk.coordinators.google | `gemini-3-flash-preview` | `google` | 1.0 | 1048576 | 150 | 5000 |
| zendesk.coordinators.google_with_subagents | `gemini-3-flash-preview` | `google` | 1.0 | 1048576 | 120 | 4000 |
| zendesk.subagents._default | `minimax/MiniMax-M2.1` | `openrouter` | 1.0 | 204800 | 60 | 1000 |
