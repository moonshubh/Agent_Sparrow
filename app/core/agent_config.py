...
from app.api_keys.schemas import APIKeyType, DecryptedAPIKey
...
class AgentConfigurationManager:
    ...
    async def _load_api_keys(self, service: APIKeyService, user_id: str, config: Dict[str, Optional[str]]) -> Dict[str, Optional[str]]:
    ...
    def validate_required_keys(self, config: Dict[str, Optional[str]]) -> Dict[str, bool]:
        """
