...
class Settings(BaseSettings):
    ...
    # Legacy Examples Flow (deprecation flag)
    # Set to False to fully disable Q&A example endpoints and processing paths
    feedme_examples_enabled: bool = Field(default=False, alias="FEEDME_EXAMPLES_ENABLED")
    ...
    # Embeddings model & limits (Gemini)
    # Embeddings model per https://ai.google.dev/gemini-api/docs/embeddings
    # Project default can be overridden via env GEMINI_EMBED_MODEL
    ...
    # FeedMe AI PDF extraction (LLM vision)
