...
class ExtractionConfig:
    """Configuration for AI extraction engine"""
...
class GemmaExtractionEngine:
    ...
    async def extract_conversations(
        ...
        if len(html_content) > 50000:
            logger.info("Large content detected, using chunking strategy")
            return await self.chunk_and_extract(html_content)
...
"""
    ...
    async def _extract_with_retry(self, prompt: str) -> Any:
        """Extract with retry logic for rate limits and errors"""
