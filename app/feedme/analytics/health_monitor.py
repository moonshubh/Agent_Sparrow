...
from .schemas import (
    HealthStatus, HealthAlert, AlertSeverity, MonitoringConfig,
    SystemHealthMetrics, ComponentHealth
)
...
class HealthMonitor:
    ...
    async def check_ai_models_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if error_rate > 0.1 or quota_remaining < 10:
                status = 'critical'
            elif error_rate > 0.05 or quota_remaining < 25 or model_response_time > 5000:
                status = 'warning'
            else:
                status = 'healthy'
    ...
    async def analyze_health_trends(
        ...
        try:
            ...
            memory_values = [float(r['memory_usage']) for r in results if r['memory_usage']]
    ...
    async def execute_recovery_actions(self, health_status: HealthStatus) -> List[Dict[str, Any]]:
    ...
    async def _store_health_result(self, health_status: HealthStatus) -> None:
        ...
        try:
            ...
            await self.db.execute(store_query, {
    ...
    async def _store_alert(self, alert: HealthAlert) -> None:
        ...
        try:
            ...
            await self.redis.ltrim("feedme:health_alerts", 0, 999)  # Keep last 1000 alerts
...
class AlertManager:
    ...
    async def get_alert_metrics(
        ...
        return {
            ...
            'alert_frequency_per_hour': total_alerts / time_window_hours if time_window_hours > 0 else 0,
