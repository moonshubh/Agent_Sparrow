...
# Comprehensive registry for all supported providers - Updated Nov 2025
MODEL_CONTEXT_WINDOWS = {
    ...
    "gpt-5.1": 400_000,                       # Latest flagship (400K context per OpenAI docs)
    "gpt-5": 1_000_000,                       # Previous flagship
