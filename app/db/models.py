...
class UserAPIKey(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("LENGTH(encrypted_key) > 0", name="non_empty_encrypted_key"),
        CheckConstraint("LENGTH(user_id) > 0", name="non_empty_user_id"),
...
class APIKeyAuditLog(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("LENGTH(user_id) > 0", name="non_empty_audit_user_id"),
    )
